export enum AuthMessages {
  ...
  API_KEY_DAILY_LIMIT_EXCEEDED = 'API_KEY_DAILY_LIMIT_EXCEEDED',
  API_KEY_MONTHLY_LIMIT_EXCEEDED = 'API_KEY_MONTHLY_LIMIT_EXCEEDED',

  // WebAuthn / Passkey
  PASSKEY_REGISTRATION_OPTIONS_GENERATED = 'PASSKEY_REGISTRATION_OPTIONS_GENERATED',
  PASSKEY_REGISTERED_SUCCESSFULLY = 'PASSKEY_REGISTERED_SUCCESSFULLY',
  PASSKEY_REGISTRATION_FAILED = 'PASSKEY_REGISTRATION_FAILED',
  PASSKEY_AUTHENTICATION_OPTIONS_GENERATED = 'PASSKEY_AUTHENTICATION_OPTIONS_GENERATED',
  PASSKEY_AUTHENTICATED_SUCCESSFULLY = 'PASSKEY_AUTHENTICATED_SUCCESSFULLY',
  ...
  PASSKEY_LIST_RETRIEVED = 'PASSKEY_LIST_RETRIEVED',
}
