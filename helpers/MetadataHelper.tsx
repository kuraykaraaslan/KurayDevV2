  ...
  public static getProfilePageJsonLd(options?: { sameAs?: string[] }) {
    return {
      ...
      mainEntity: {
        ...
        description:
          'Software architect and product engineer—also working as a BIM developer (Building Information Modeling automation) and IoT developer (real-time telemetry systems)—designing production-grade SaaS, integration, and real-time platforms across architecture, backend, frontend, and infrastructure. Yazılım mimarı ve ürün mühendisi olarak, aynı zamanda bir BIM geliştiricisi (Yapı Bilgi Modellemesi otomasyonu) ve IoT geliştiricisi (gerçek zamanlı telemetri sistemleri) olarak çalışıyor; mimari, arka uç, ön uç ve altyapı genelinde üretim düzeyinde SaaS, entegrasyon ve gerçek zamanlı platformlar tasarlıyorum.',
        url: NEXT_PUBLIC_APPLICATION_HOST,
        image: `${NEXT_PUBLIC_APPLICATION_HOST}/assets/img/og.png`,
        jobTitle: 'Software Architect & Product Engineer / Yazılım Mimarı ve Ürün Mühendisi',
        hasOccupation: [
          { '@type': 'Occupation', name: 'Software Architect' },
          { '@type': 'Occupation', name: 'BIM Developer' },
          { '@type': 'Occupation', name: 'IoT Developer' },
          { '@type': 'Occupation', name: 'Yazılım Mimarı' },
          { '@type': 'Occupation', name: 'BIM Geliştiricisi' },
          { '@type': 'Occupation', name: 'IoT Geliştiricisi' },
        ],
