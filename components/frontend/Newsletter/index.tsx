        ...
        <div className="bg-base-200 py-16 px-6">
            <div className="max-w-5xl mx-auto text-center">
                ...
                <div className="mt-12 flex items-center overflow-hidden rounded-md max-w-xl mx-auto">
                    <input type="email" placeholder="Enter your email" className="w-full bg-transparent py-3.5 px-4 text-base focus:outline-none bg-base-100 border border-primary focus:border-primary rounded-l-md" />
