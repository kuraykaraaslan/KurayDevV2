...
const SingleSkill = ({ title, icon, bgColor, textColor }: Partial<Skill>) => {
  ...
  return (
    <div className="w-28 h-20 group">
      <div
        className={`relative card w-28 h-24 from-base-100 to-base-300 bg-gradient-to-b shadow-lg relative select-none transition duration-500 transform group-hover:rotate-y-180 shadow-lg`}
      >
