                ...
                <footer className="flex justify-between items-center mb-2">
                    <div className="flex items-center">
                        <p className="inline-flex items-center mr-3 text-sm font-semibold"><img
                            ...
                            src={gravatarUrl} alt={name || t('frontend.comments.anonymous')} />{name || t('frontend.comments.anonymous')}</p>
                        <p className="text-sm">
                    ...
                    <details className="dropdown dropdown-end">
                        ...
                        <ul className="menu dropdown-content bg-base-100 rounded-box z-[1] w-52 p-2 shadow">
                            <li><button onClick={handleReply}>{t('frontend.comments.reply')}</button></li>
                            <li><button onClick={handleDelete}>{t('frontend.comments.delete')}</button></li>
                        </ul>
                    </details>
                    }
                </footer>
