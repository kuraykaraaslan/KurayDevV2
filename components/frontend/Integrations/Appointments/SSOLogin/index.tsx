...
const SSOLoginContent = ({ mode }: { mode: SSOLoginMode }) => {
  ...
  if (allowedProviders.length === 0) {
    return <div className="text-center text-sm text-gray-500">{t('auth.sso.no_providers')}</div>
  }
    ...
    <div
      className={
        mode === 'list'
          ...
          : 'flex flex-row flex-wrap space-x-2 justify-center'
      }
    >
