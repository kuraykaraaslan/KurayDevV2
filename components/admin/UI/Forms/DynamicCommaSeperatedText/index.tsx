...
const DynamicCommaSeperatedText: React.FC<DynamicCommaSeperatedTextProps> = ({
  ...
  const badgeSizeClass = size === 'sm' ? 'badge-sm' : size === 'lg' ? 'badge-lg' : 'badge-md'
  ...
  return (
    <GenericElement label={label} className={className}>
      <div
        className={`input ${sizeClass} w-full h-auto min-h-12 flex flex-wrap gap-2 items-center py-2`}
      >
