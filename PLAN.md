...
| 215 | **WebAuthn / Passkey Desteği** — Şifresiz giriş; `navigator.credentials.create/get` tarayıcı API; `WebAuthnCredential` tablosu; `AuthService` OTP akışına paralel branch olarak eklenir; `passkey` `SSOService` kalıbına uyumlu | `[x]` |
