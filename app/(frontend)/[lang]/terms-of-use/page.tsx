...
const title = 'Terms of Use | Kuray Karaaslan'
const description =
  'Terms of Use for kuray.dev — Rules and guidelines for using this website and its services.'
...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: `${APPLICATION_HOST}/terms-of-use`,
  },
}
