...
const CategoryPage = () => {
    ...
    const columns: ColumnDef<Category>[] = [
        { key: 'image', header: 'admin.categories.image', className: 'w-16', accessor: (c) => <ImageCell src={c.image} alt={c.title} /> },
    ...
    const actions: ActionButton<Category>[] = [
        { label: 'admin.categories.edit', href: (c) => `/admin/categories/${c.categoryId}`, className: 'btn-secondary' },
        { label: 'admin.categories.view', href: (c) => `/blog/${c.slug}`, className: 'btn-primary' },
        { label: 'admin.categories.posts', href: (c) => `/admin/categories/${c.categoryId}/posts`, className: 'btn-warning', hideOnMobile: true },
        { 
