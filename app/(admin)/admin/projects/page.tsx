...
const ProjectPage = () => {
    ...
    const columns: ColumnDef<Project>[] = [
        { key: 'image', header: '', className: 'w-16', accessor: (p) => <ImageCell src={p.image} alt={p.title} /> },
        { key: 'title', header: 'admin.projects.project_name', accessor: (p) => p.title },
        { key: 'technologies', header: 'admin.projects.tech_stack', className: 'max-w-20', accessor: (p) => p.technologies?.join(', ') || '-' },
    ...
    const actions: ActionButton<Project>[] = [
        { label: 'admin.projects.edit', href: (p) => `/admin/projects/${p.projectId}`, className: 'btn-primary' },
